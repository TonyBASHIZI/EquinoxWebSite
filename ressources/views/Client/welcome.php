        ...
        <div class="row">
            ...
            <div class="col-lg-6 pt-3 pt-lg-0 content">
                <h3>À PROPOS D’EQUINOX MÉDIA
                    GROUP</h3>
                <p class="fst-italic">
                    Nous sommes Equinox Média Group, un spécialiste de la concep tion, de l'impression, de l'image de
                    marque et de l'emballage en RDC et dans la région de l'Afrique de l'Est. Depuis 2013, nous avons
                    réalisé un très grand nombre de projets d'impression de haut niveau et obtenu un grand succès.
                    Equinox Média est un fournisseur de solutions d'impres sion intégrées offrant un guichet unique
                    d'impression

                </p>
                <ul>
                    <li><i class="bx bx-check-double"></i>Offset et
                        Numérique Impression
                    </li>
                    <li><i class="bx bx-check-double"></i> Articles promotionnels Fourniture
                    </li>
                    <li><i class="bx bx-check-double"></i> Large Format Impression

                    </li>
                    <li><i class="bx bx-check-double"></i>Equinox Média Group a investi dans les derniers équipements de
                        pointe tels que l'allemand Heidelberg 5 Colors Speed Master, la presse numérique Indigo et les
                        dernières technolo gies de machines d'impression grand format</li>
                </ul>
                <p>
                    Nous fournissons des concepts exceptionnels, des mises en page pour votre entreprise
                </p>
            </div>
            ...
            <div class="tab-pane active show" id="tab-1">
                <div class="row">
                    <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                        ...
                        <ul>
                            <li><i class="ri-check-double-line"></i> Livres
                                - Calendriers
                            </li>
                            <li><i class="ri-check-double-line"></i> Bannières en pvc - Autocollants en vinyle </li>
                            <li><i class="ri-check-double-line"></i> T-shirts
                                - Drapeaux
                                - Chemises
                                - Sacs cadeaux
                            </li>
                            ...
                            <li><i class="ri-check-double-line"></i>
                                ...
                                - Cartes de visite - Cartes d'invitation

                            </li>
                            <li><i class="ri-check-double-line"></i>
                                Autocollants de sol - Mannequins
                                - Lettres 3D
                                - Gravures
                            ...
                            <li><i class="ri-check-double-line"></i>
                                ...
                                - Stylos
                                - Brassards de whist - Corbeilles à papier - Couvre-pneus
            ...
            <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                    ...
                    <p>Vous cherchez un moyen différent de faire passer votre message ? Rien ne fait une grande
                        ...
                        utilisés pour vos besoins en grand format</p>
                </div>
            </div>
            <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                    ...
                    <p>L'emballage est devenu une partie importante du produit. Avec le bon matériau, la bonne
                        ...
                        meilleure rentabilité pour nos clients et c'est pourquoi nous tendons à leur offrir la meilleure
                        qualité possible dans la région</p>
                </div>
            </div>
            <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
