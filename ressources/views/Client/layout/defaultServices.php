...
<body>
    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html"><img src="../assets/img/equinox_media.png" alt=""
                        class="img-fluid">Equinox</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <!-- <li class="dropdown"><a href="#"><span>SERVICES</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="index.php?p=home">Equinox</a></li>
                            <li><a href="index.php?p=home">Parteners</a></li>
    ...
    <footer id="footer">
            ...
            <div class="container">
                <div class=" row ">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-info">
                            ...
                            <p>
                                A108 Adam Street <br>
                                NY 535022, DRC<br><br>
                                <strong>Phone:</strong> +243 00000000<br>
                    ...
                    <div class="col-lg-2 col-md-6 footer-links">
                        <h4>Menu</h4>
                        <ul>
                            <li><i class=" bx bx-chevron-right "></i> <a href="index.php?p=home">Accueil</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Nos Services</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right "></i> <a href="#">Impression</a></li>
                            <li><i class="bx bx-chevron-right "></i> <a href=" # ">Marketing digital</a></li>
                            <li><i class="bx bx-chevron-right "></i> <a href=" # ">Panneaux publicitaire</a></li>
                            <li><i class="bx bx-chevron-right "></i> <a href=" # ">Design pub</a></li>
                            <li><i class="bx bx-chevron-right "></i> <a href=" # ">Graphic Design</a></li>
                        </ul>
                    </div>

                    <div class="col-lg-4 col-md-6 footer-newsletter">
                        <h4>Laissez nous votre adresse mail</h4>
                        <p>Nous vous contacterons plus rapidement que possible</p>
        ...
        <div class="container">
            <div class="copyright">
                &<strong><span>Equinox</span></strong>
            </div>
            <div class="credits">
